...
def blur(img):
    ...
    img = cv.GaussianBlur(img,(5,5),0) #use gaussian blur
...
def contours(img): #draw contours
...
while cap.isOpened():
    ...
    img = increaseContrast(img, 3 , 15) #increase contrast
    # canny edge detection
    img = canny(img)
     #dilate edges to blot out noisy edges
